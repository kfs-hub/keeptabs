      ...
      <div className="relative z-10 w-full max-w-lg space-y-6">
        <div className="text-center">
          <div className="inline-flex items-center gap-2 mb-4">
            <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-violet-500 to-violet-700 flex items-center justify-center text-2xl shadow-sm">
              💸
            </div>
          </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          <Link href="/groups/new">
            <Card className="cursor-pointer hover:border-violet-500/50 transition-all group h-full">
              <CardContent className="p-6 text-center space-y-3">
                ...
                <h3 className="text-lg font-semibold text-zinc-900">Create a Group</h3>
          ...
          <Link href="/groups/join">
            <Card className="cursor-pointer hover:border-violet-500/50 transition-all group h-full">
              <CardContent className="p-6 text-center space-y-3">
                <div className="text-5xl group-hover:scale-110 transition-transform">🔗</div>
                <h3 className="text-lg font-semibold text-zinc-900">Join a Group</h3>
                <p className="text-sm text-zinc-500">
