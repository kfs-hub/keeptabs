      ...
      <div className="relative z-10 w-full max-w-xl space-y-6 py-8">
        <div className="text-center space-y-2">
          <div className="inline-flex items-center gap-2 mb-2">
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-violet-500 to-violet-700 flex items-center justify-center text-2xl shadow-xl shadow-violet-500/30">
              👥
            </div>
          </div>
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 pt-2">
          <Link href="/groups/new" className="w-full sm:flex-1">
            <Button variant="outline" className="w-full gap-2 border-white/10 hover:border-violet-500/30">
